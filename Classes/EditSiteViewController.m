...
- (UITableViewCell *)tableView:(UITableView *)tv cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
		...
		if ([indexPath section] == 0) {
			UITextField *addTextField = [[UITextField alloc] initWithFrame:CGRectMake(140, 10, 162, 30)];
...
- (void)saveSiteInBackground {
	...
	[updatedBlog setValue:authUsername forKey:@"authUsername"];
	[updatedBlog setValue:authPassword forKey:@"authPassword"];
	...
	[[BlogDataManager sharedDataManager] wrapperForSyncPostsAndGetTemplateForBlog:updatedBlog];
