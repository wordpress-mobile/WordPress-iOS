//
//  NewAppAnnounceViewController.m
//  WordPress
//
//  Created by John Bickerstaff on 10/21/09.
...
@interface NewAppAnnounceViewController( private )
-(void) loadWebView;
@end

@implementation NewAppAnnounceViewController
...
-(void) loadWebView {
	...
	[webView loadHTMLString:[NSString stringWithFormat:@"<font face=\"Helvetica\"> <p style=\"color:rgb(51,51,51);padding-top:8px;\"><br><br><br><br><br><br><br><br><br><br><b style=\"font-size:18px;\">WordPress for iPhone</b><br>Version %@<br><br>"
							 "Announcing WP for iPhone 2.0!.<br><br>"
							 "Go here for more information.<br><br>"
							 "This is the place,<br />our web site at <a style=\"color:rgb(37,131,173);text-decoration:none\" href=\"http://iphone.wordpress.org/\">iphone.wordpress.org</a>.</p></font>",version] baseURL:nil];
