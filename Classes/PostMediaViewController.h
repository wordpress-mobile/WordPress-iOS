...
@interface PostMediaViewController : UIViewController <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, UIAlertViewDelegate, UIPopoverControllerDelegate, UITextFieldDelegate> {
	...
	BOOL isLibraryMedia, didChangeOrientationDuringRecord, isShowingResizeActionSheet, isShowingCustomSizeAlert, videoEnabled, isCheckingVideoCapability;
...
@property (nonatomic, assign) BOOL isLibraryMedia, didChangeOrientationDuringRecord, isShowingResizeActionSheet, isShowingCustomSizeAlert, videoEnabled, isCheckingVideoCapability;
