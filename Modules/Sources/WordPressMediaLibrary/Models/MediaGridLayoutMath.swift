...
/// `SiteMediaCollectionViewController.updateFlowLayoutItemSize`: 4 cells per
/// row below 500pt width, 5 otherwise; spacing 2 in default mode, 8 in
/// aspect-ratio mode; cell size rounded down to avoid fractional pixels.
