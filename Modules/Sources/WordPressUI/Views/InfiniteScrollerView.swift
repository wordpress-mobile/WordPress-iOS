...
public protocol InfiniteScrollViewDelegate: AnyObject {
    /// Called on every step of `CADisplayLink` to adjust the `InfiniteScrollView`'s offset.
    ///
...
public final class InfiniteScrollView: UIScrollView {
    ...
    public weak var scrollerDelegate: InfiniteScrollViewDelegate?
    ...
    public init(frame: CGRect = .zero, _ viewBuilder: @escaping (() -> UIView)) {
        super.init(frame: frame)
