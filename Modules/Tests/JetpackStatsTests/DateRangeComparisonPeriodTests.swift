...
struct DateRangeComparisonPeriodTests {
    ...
    @Test
    func testCanCompareSamePeriodLastYearForDay() {
        // GIVEN
        let dateRange = StatsDateRange(
        ...
        // THEN
        #expect(dateRange.isComparisonPeriodEnabled(.samePeriodLastYear) == true)
    }

    @Test
    func testCanCompareSamePeriodLastYearForMonth() {
        // GIVEN
        let dateRange = StatsDateRange(
            interval: DateInterval(
                start: Date("2025-01-01T00:00:00Z"),
    ...
    @Test
    func testCannotCompareSamePeriodLastYearForYear() {
        // GIVEN
        let dateRange = StatsDateRange(
            interval: DateInterval(
                start: Date("2025-01-01T00:00:00Z"),
        ...
        // THEN
        #expect(dateRange.isComparisonPeriodEnabled(.samePeriodLastYear) == false)
    }

    @Test
    func testCanCompareSamePeriodLastYearForCustomRange() {
        // GIVEN - Custom 7-day range
        let dateRange = StatsDateRange(
            interval: DateInterval(
                start: Date("2025-01-08T00:00:00Z"),
                end: Date("2025-01-15T00:00:00Z")
        ...
        // THEN - Should be allowed since it's not a year
        #expect(dateRange.isComparisonPeriodEnabled(.samePeriodLastYear) == true)
    }
