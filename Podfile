...
pod 'WordPress-iOS-Editor', :git => 'git://github.com/wordpress-mobile/WordPress-iOS-Editor', :branch => 'release/0.2.2', :commit => '91eec3470a63bb1737a7c9e9b97d44fc26ca0edf'
pod 'WordPressCom-Stats-iOS', '0.1.4'
pod 'WordPressCom-Analytics-iOS', '0.0.10'
pod 'NSObject-SafeExpectations', '0.0.2'
