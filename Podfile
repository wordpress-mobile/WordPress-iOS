...
target 'WordPress', :exclusive => true do
  ...
  pod 'WordPressCom-Stats-iOS/UI', :git => "https://github.com/wordpress-mobile/WordPressCom-Stats-iOS.git", :branch => "temporary-workaround-for-6.0"
...
target 'WordPressTodayWidget', :exclusive => true do
  pod 'WordPress-iOS-Shared', '0.5.1'
  pod 'WordPressCom-Stats-iOS/Services', :git => "https://github.com/wordpress-mobile/WordPressCom-Stats-iOS.git", :branch => "temporary-workaround-for-6.0"
end
