...
#  pod 'WordPressAuthenticator', '~> 7.2'
   pod 'WordPressAuthenticator', git: 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', branch: 'fix/20985-login-with-site-address-is-blocked-after-failing-the-first-attempt'
