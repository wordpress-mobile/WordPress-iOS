...
def wordpress_kit
    ...
    #pod 'WordPressKit', :git => 'https://github.com/wordpress-mobile/WordPressKit-iOS.git', :tag => '4.7.0-beta.1'
...
target 'WordPress' do
    ...
    pod 'WordPressAuthenticator', '~> 1.12.0-beta.2'
    # While in PR
    # pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :tag => '1.12.0-beta.2'
