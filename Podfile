...
target 'WordPress' do
    ...
    # While in PR
    pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :branch => 'feature/495-extend-background-carousel-container'
