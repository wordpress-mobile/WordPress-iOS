...
target 'WordPress' do
    ...
    # pod 'WordPressAuthenticator', '~> 1.11.0-beta.16'
    # While in PR
    pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :branch => 'issue/13620-apple_button_appearance'
