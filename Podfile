...
target 'WordPress' do
    ...
    pod 'react-native-keyboard-aware-scroll-view', :git => 'https://github.com/wordpress-mobile/react-native-keyboard-aware-scroll-view.git', :commit => 'a26ca2ab00200843ec6c17e0336aea951d936757'
