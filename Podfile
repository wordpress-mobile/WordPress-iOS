...
target 'WordPress' do
    ...
    # pod 'WordPressAuthenticator', '~> 1.17.0-beta.10'
    # While in PR
    pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :branch => 'feature/282-new_google_view'
