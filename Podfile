...
pod 'WordPress-iOS-Editor', :git => 'git://github.com/wordpress-mobile/WordPress-iOS-Editor', :branch => 'release/0.2.3', :commit => '68e86853ad1d49c05031f62726c56804d2c08ad0'
pod 'WordPressCom-Stats-iOS', '0.1.4'
pod 'WordPressCom-Analytics-iOS', '0.0.11'
pod 'NSObject-SafeExpectations', '0.0.2'
