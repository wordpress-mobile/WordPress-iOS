...
pod 'wpxmlrpc', '~> 0.4.1'
pod 'WordPressApi', :git => 'https://github.com/wordpress-mobile/WordPressApi.git', :branch => 'afnetworking2'
pod 'NSObject-SafeExpectations', '0.0.2'
pod 'Mixpanel', '2.3.1'
pod 'CocoaLumberjack', '~>1.8.1'
pod 'NSLogger-CocoaLumberjack-connector', '~>1.3'
pod 'google-plus-ios-sdk', '~>1.5'
pod 'MGImageUtilities', :git => 'git://github.com/jleandroperez/MGImageUtilities.git', :branch => 'gifsupport'
...
pod 'WordPress-iOS-Shared', '0.0.3'
