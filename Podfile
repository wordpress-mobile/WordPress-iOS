...
pod 'WordPress-iOS-Editor', :git => 'git://github.com/wordpress-mobile/WordPress-Editor-iOS', :commit => 'e0fdaed914aa53e15cc5f26894997f4cba91bf0c'
pod 'WordPressCom-Stats-iOS', '0.2.3'
pod 'WordPressCom-Analytics-iOS', '0.0.27'
pod 'NSObject-SafeExpectations', '0.0.2'
