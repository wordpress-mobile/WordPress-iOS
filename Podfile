...
def aztec
    ...
    ##
    pod 'WordPress-Aztec-iOS', :git => 'https://github.com/wordpress-mobile/AztecEditor-iOS.git', :branch => 'feature/format-bar-customization'
    pod 'WordPress-Editor-iOS', :git => 'https://github.com/wordpress-mobile/AztecEditor-iOS.git', :branch => 'feature/format-bar-customization'
    ...
    ## pod 'WordPress-Editor-iOS', :path => '../AztecEditor-iOS' #~> 1.8.0'
end
...
target 'WordPress' do
    ...
    pod 'WordPressAuthenticator', '~> 1.8.0-beta.6'
