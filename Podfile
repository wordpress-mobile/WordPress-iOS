...
pod 'wpxmlrpc', '~> 0.4.3'
pod 'WordPressApi', :git => 'https://github.com/wordpress-mobile/WordPressApi.git', :tag => '0.0.1'
...
pod 'WordPress-iOS-Editor', :git => 'git://github.com/wordpress-mobile/WordPress-iOS-Editor', :commit => '463ec96642b8705b85d8997dbc8df8fcb6e075eb'
