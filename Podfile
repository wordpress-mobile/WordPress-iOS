...
target 'WordPress' do
    ...
    pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :branch => 'issue/12535-siwa_observe_revoked_notification'
