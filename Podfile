...
pod 'AMPopTip', '~> 0.7'
pod 'wpxmlrpc', '~> 0.7'
pod 'WordPressApi', :git => 'https://github.com/wordpress-mobile/WordPressApi.git', :branch => 'master'
...
pod 'WordPress-iOS-Editor', :git => 'git://github.com/wordpress-mobile/WordPress-iOS-Editor', :commit => 'ab6005aecc427398d833d2b40856def8c147bec0'
