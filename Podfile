...
target 'WordPress' do
    ...
    #pod 'WordPressAuthenticator', '~> 1.10.7-beta.2'
    pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :branch => 'issue/auth_init_configs'
