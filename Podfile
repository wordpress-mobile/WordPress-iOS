...
pod 'WordPress-iOS-Editor', :git => 'https://github.com/wordpress-mobile/WordPress-Editor-iOS.git', :commit => '60b01f7c7bbf6b6e950c82c754055b68f2b0ff7a'
pod 'WordPressCom-Stats-iOS', '0.3.5'
pod 'WordPressCom-Analytics-iOS', '0.0.32'
