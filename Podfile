...
def wordpress_shared
    ## for production:
    pod 'WordPressShared', '1.8.15-beta.2'
...
def wordpress_kit
    ...
    pod 'WordPressKit', :git => 'https://github.com/wordpress-mobile/WordPressKit-iOS.git', :commit => '36f28b0d7d6cce66044333acb626583786320956'
