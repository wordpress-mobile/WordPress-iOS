...
target 'WordPress' do
    ...
    ## =====================
    ##
    gutenberg :commit => 'ee3241c578d4f93ddd9180295a7deeaac946f7a0'
    ...
    pod 'MediaEditor', :git => 'https://github.com/wordpress-mobile/MediaEditor-iOS.git', :commit => '8d77f0fef4c45d21ebc4e032144140ee4c8d1525'
