...
def wordpress_shared
    ...
    pod 'WordPressShared', :git => 'https://github.com/wordpress-mobile/WordPress-iOS-Shared', :branch => 'issue/12920_adds_added_photo_via_media_editor_analytics'
...
def aztec
    ...
    ##
    pod 'WordPress-Aztec-iOS', :git => 'https://github.com/wordpress-mobile/AztecEditor-iOS.git', :branch => 'issue/12920_adds_is_loaded_property'
    ...
    pod 'WordPress-Editor-iOS', :git => 'https://github.com/wordpress-mobile/AztecEditor-iOS.git', :branch => 'issue/12920_adds_is_loaded_property'
end
