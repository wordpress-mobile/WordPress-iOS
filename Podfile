...
target 'WordPress' do
  ...
  pod 'Gridicons', '0.12'
  pod 'NSURL+IDN', '0.3'
  # WPMediaPicker pointing to fork for test purposes only.
  pod 'WPMediaPicker', :git => 'https://github.com/etoledom/MediaPicker-iOS.git', :commit => '48ac5d7c462467cb05153fc5edecd89cefb932f1'
