...
pod 'WordPress-iOS-Shared', :git => 'https://github.com/wordpress-mobile/WordPress-iOS-Shared.git', :tag => '0.0.9'
pod 'WordPress-iOS-Editor', '0.1.6'
pod 'WordPressCom-Stats-iOS', '0.1.0'
pod 'WordPressCom-Analytics-iOS', '0.0.3'
pod 'NSObject-SafeExpectations', '0.0.2'
