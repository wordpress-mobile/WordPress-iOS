...
# Process all app icons and create the corresponding develop build icons
...
icons_dest_path="${PROJECT_DIR}/Resources/AppImages.xcassets/AppIcon-Debug.appiconset"
...
icons_dest_path="${PROJECT_DIR}/Resources/Icons-Debug"
