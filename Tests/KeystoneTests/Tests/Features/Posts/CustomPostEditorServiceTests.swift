...
func makeRemotePost(
    ...
    password: String? = nil,
    author: UserId? = nil,
    title: PostTitleWithEditContext? = nil,
    content: PostContentWithEditContext = PostContentWithEditContext(raw: nil, rendered: "", protected: nil, blockVersion: nil),
    excerpt: SparsePostExcerpt? = nil,
    featuredMedia: MediaId? = nil,
    commentStatus: PostCommentStatus? = .open,
    pingStatus: PostPingStatus? = .open,
    format: PostFormat? = nil,
    sticky: Bool? = nil,
    dateGmt: WpGmtDateTime = Date(timeIntervalSince1970: 0),
    parent: PostId? = nil,
