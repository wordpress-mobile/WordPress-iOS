...
class SiteStatsImmuTableRowsTests: XCTestCase {
    ...
    func testViewVisitorsImmuTableRows() throws {
        ...
        let rows = SiteStatsImmuTableRows.viewVisitorsImmuTableRows(statsSummaryTimeIntervalData, selectedSegment: .views, periodDate: date, siteStatsInsightsDelegate: nil, viewsAndVisitorsDelegate: nil)
