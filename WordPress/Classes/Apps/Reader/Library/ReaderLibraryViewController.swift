...
final class ReaderLibraryViewController: ReaderSidebarViewController {
    init() {
        let viewModel = ReaderSidebarViewModel(isReaderModeEnabled: true)
...
//final class ReaderLibraryViewController2: UIHostingController<AnyView>, UIPopoverPresentationControllerDelegate {
...
//            case .lists:
//                ReaderListsView(viewModel: viewModel)
//            case .tags:
