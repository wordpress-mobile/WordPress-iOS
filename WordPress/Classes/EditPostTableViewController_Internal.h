//
//  EditPostTableViewController_Internal.h
//  WordPress
//
//  Created by aerych on 12/5/13.
...
typedef NS_ENUM(NSInteger, EditPostTableViewControllerAlertTag) {
    EditPostTableViewControllerAlertTagNone,
    EditPostTableViewControllerAlertTagLinkHelper,
    EditPostTableViewControllerAlertTagFailedMedia,
};

typedef NS_ENUM(NSUInteger, EditPostTableViewControllerMode) {
	EditPostTableViewControllerModeNewPost,
	EditPostTableViewControllerModeEditPost
};

@interface EditPostTableViewController () <UIActionSheetDelegate, UITextFieldDelegate, UITextViewDelegate, WPKeyboardToolbarDelegate>
...
@property (nonatomic, assign) EditPostTableViewControllerMode editMode;
