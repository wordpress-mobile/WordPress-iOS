...
extension UIView {
    ...
    ///
    func normalizeSpringAnimation(_ completion: ((Bool) -> Void)? = nil) {
    ...
    ///
    func expandSpringAnimation(_ completion: ((Bool) -> Void)? = nil) {
        let duration        = 0.5
        let delay           = 0.2
    ...
    ///
    func fadeInWithRotationAnimation(_ completion: ((Bool) -> Void)? = nil) {
    ...
    ///
    func fadeOutWithRotationAnimation(_ completion: ((Bool) -> Void)? = nil) {
        UIView.animate(withDuration: Animations.duration, animations: {
    ...
    ///
    func explodeAnimation(_ completion: ((Bool) -> Void)? = nil) {
        UIView.animate(withDuration: Animations.duration, animations: {
    ...
    ///
    func implodeAnimation(_ completion: ((Bool) -> Void)? = nil) {
