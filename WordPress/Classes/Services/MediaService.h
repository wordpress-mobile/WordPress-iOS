...
/**
 *  @brief      Removes all unused media files from the media directorys
 *  
 *  @discussion This method looks for any media files that stored inside the media folder that aren't
 * linked to any valid media object and remove them. This files can show up because of the app being killed
