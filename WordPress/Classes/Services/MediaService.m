                    ...
                    blog:(Blog *)blog
{
    if (error.code == NSURLErrorCancelled) {
        ...
        [WPAppAnalytics track:WPAnalyticsStatMediaServiceUploadFailed error:error withProperties:properties withBlogID:blog.dotComID];
    }
}
...
- (NSMutableDictionary *)blogPropertiesToTrack:(Blog *)blog {
    ...
    properties[WPAppAnalyticsKeyIsJetpack] = @(blog.jetpack.isConnected);
