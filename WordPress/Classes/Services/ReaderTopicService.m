                       ...
                       failure:(void (^)(BOOL follow, NSError *error))failure
{
    ...
    if (topic.isExternal) {
        ...
        if (newFollowValue) {
            [siteService followSiteWithID:[topic.siteID integerValue] fromTopic:topic fromPost:nil success:successBlock failure:failureBlock];
        } else {
            ...
            [siteService unfollowSiteWithID:[topic.siteID integerValue] fromTopic:topic fromPost:nil success:successBlock failure:^(NSError *error) {
