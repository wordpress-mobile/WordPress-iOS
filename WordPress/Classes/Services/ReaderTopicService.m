                       ...
                       failure:(void (^)(BOOL follow, NSError *error))failure
{
    ...
    if (topic.isExternal) {
        ...
        if (newFollowValue) {
            [siteService followSiteWithID:[topic.siteID integerValue] topic:topic post:NULL success:successBlock failure:failureBlock];
        } else {
            ...
            [siteService unfollowSiteWithID:[topic.siteID integerValue] topic:topic post:NULL success:successBlock failure:^(NSError *error) {
