...
struct RemoteConfigOverrideStore {
    ...
    private func key(for param: RemoteConfigParameter) -> String {
        return "remote-config-override-\(String(describing: param))"
    }

    /// - returns: True if the specified parameter is overridden
    ///
    func isOverridden(_ param: RemoteConfigParameter) -> Bool {
        return overriddenValue(for: param) != nil
    }

    /// Stores the new overridden value
    ///
    func override(_ param: RemoteConfigParameter, withValue value: String) {
    ...
    ///
    func reset(_ param: RemoteConfigParameter) {
        let key = self.key(for: param)
    ...
    ///
    func overriddenValue(for param: RemoteConfigParameter) -> String? {
