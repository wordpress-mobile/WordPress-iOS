...
fileprivate extension NewBlogDetailHeaderView {
    class TitleView: UIView {
        ...
        let subtitleButton: UIButton = {
            ...
            button.accessibilityHint = AppLocalizedString("Tap to view your site", comment: "Accessibility hint for button used to view the user's site")
        ...
        let titleButton: SpotlightableButton = {
            ...
            button.accessibilityHint = AppLocalizedString("Tap to change the site's title", comment: "Accessibility hint for button used to change site title")
        ...
        let siteSwitcherButton: UIButton = {
            ...
            button.accessibilityLabel = AppLocalizedString("Switch Site", comment: "Button used to switch site")
            button.accessibilityHint = AppLocalizedString("Tap to switch to another site, or add a new site", comment: "Accessibility hint for button used to switch site")
