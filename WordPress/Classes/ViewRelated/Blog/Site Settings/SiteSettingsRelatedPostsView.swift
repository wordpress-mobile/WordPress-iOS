...
struct RelatedPostsSettingsView: View {
    ...
    var body: some View {
        ...
        .toggleStyle(SwitchToggleStyle(tint: Color(AppStyleGuide.jetpackGreen)))
    ...
    private var settingsSection: some View {
        ...
        return section.tint(Color(AppStyleGuide.jetpackGreen))
    }
            ...
            VStack(spacing: settings.relatedPostsShowThumbnails ? 10 : 5) {
                if settings.relatedPostsShowHeadline {
                    Text(Strings.relatedPostsHeader)
                        ...
                        .foregroundColor(Color(AppStyleGuide.neutral))
            ...
            HStack {
                VStack(alignment: .leading, spacing: 0) {
                    Text(viewModel.title)
                        ...
                        .foregroundColor(Color(AppStyleGuide.neutral(.shade70)))
