...
struct RelatedPostsSettingsView: View {
    ...
    var body: some View {
        ...
        .toggleStyle(SwitchToggleStyle(tint: Color(AppColor.jetpackGreen)))
    ...
    private var settingsSection: some View {
        ...
        return section.tint(Color(AppColor.jetpackGreen))
    }
            ...
            VStack(spacing: settings.relatedPostsShowThumbnails ? 10 : 5) {
                if settings.relatedPostsShowHeadline {
                    Text(Strings.relatedPostsHeader)
                        ...
                        .foregroundColor(Color(AppColor.neutral))
            ...
            HStack {
                VStack(alignment: .leading, spacing: 0) {
                    Text(viewModel.title)
                        ...
                        .foregroundColor(Color(AppColor.neutral(.shade70)))
