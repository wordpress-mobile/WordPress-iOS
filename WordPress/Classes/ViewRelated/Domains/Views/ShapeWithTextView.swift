...
struct ShapeWithTextView: View {
    ...
    private enum Appearance {
        ...
        static let largeRoundedRectangleDefaultTextColor = Color(AppStyleGuide.primary)
        ...
        static let smallRoundedRectangleDefaultBackgroundColor = Color(AppStyleGuide.green(.shade5))
        static let smallRoundedRectangleDefaultTextColor = Color(AppStyleGuide.green(.shade100))
