...
struct ShapeWithTextView: View {
    ...
    private enum Appearance {
        ...
        static let largeRoundedRectangleDefaultTextColor = Color(AppColor.primary)
        ...
        static let smallRoundedRectangleDefaultBackgroundColor = Color(AppColor.green(.shade5))
        static let smallRoundedRectangleDefaultTextColor = Color(AppColor.green(.shade100))
