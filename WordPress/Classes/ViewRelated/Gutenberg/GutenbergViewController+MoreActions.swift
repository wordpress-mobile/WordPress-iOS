...
extension GutenbergViewController {
    ...
    func displayMoreSheet() {
        ...
        if mode == .richText, let contentInfo = contentInfo {
            ...
            let textCounterTitle = String(format: NSLocalizedString("%li block(s), %li word(s), %li character(s)", comment: "Displays the number of blocks, words and characters in text"), contentInfo.wordCount, contentInfo.characterCount)
