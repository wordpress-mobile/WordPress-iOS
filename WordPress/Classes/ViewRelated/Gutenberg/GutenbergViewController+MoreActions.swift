...
extension GutenbergViewController {
    ...
    func displayMoreSheet() {
        ...
        if mode == .richText, let contentInfo = contentInfo {
            ...
            let textCounterTitle = String(format: NSLocalizedString("%li words, %li characters", comment: "Displays the number of words and characters in text"), contentInfo.wordCount, contentInfo.characterCount)
