...
/// This works similarly to GutenbergBlockProcessor however it provides support for nested blocks of the same type.
///
public class GutenbergBlockTreeProcessor: Processor {
