...
private extension JetpackBrandingMenuCardCell {
    ...
    enum Metrics {
        ...
        enum Compact {
            ...
            static let ellipsisButtonColor = AppStyleGuide.gray(.shade20)
            static var labelFont: UIFont {
            ...
            static let labelTextColor: UIColor = AppStyleGuide.jetpackGreen(.shade40)
        }
        ...
        static let learnMoreButtonTextColor: UIColor = AppStyleGuide.jetpackGreen(.shade40)
    }
