...
private extension JetpackBrandingMenuCardCell {
    ...
    enum Metrics {
        ...
        enum Compact {
            ...
            static let ellipsisButtonColor = AppColor.gray(.shade20)
            static var labelFont: UIFont {
            ...
            static let labelTextColor: UIColor = AppColor.jetpackGreen(.shade40)
        }
        ...
        static let learnMoreButtonTextColor: UIColor = AppColor.jetpackGreen(.shade40)
    }
