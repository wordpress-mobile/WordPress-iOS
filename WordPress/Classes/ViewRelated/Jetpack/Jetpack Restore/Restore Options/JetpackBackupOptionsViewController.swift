...
class JetpackBackupOptionsViewController: BaseRestoreOptionsViewController {
    ...
    override init(site: JetpackSiteRef, activity: Activity) {
        let restoreOptionsConfiguration = JetpackRestoreOptionsConfiguration(
            title: AppLocalizedString("Download Backup", comment: "Title for the Jetpack Download Backup Site Screen"),
            iconImage: UIImage.gridicon(.history),
            messageTitle: AppLocalizedString("Create downloadable backup", comment: "Label that describes the download backup action"),
            messageDescription: AppLocalizedString("%1$@ is the selected point to create a downloadable backup.", comment: "Description for the download backup action. $1$@ is a placeholder for the selected date."),
            generalSectionHeaderText: AppLocalizedString("Choose the items to download", comment: "Downloadable items: general section title"),
            buttonTitle: AppLocalizedString("Create downloadable file", comment: "Button title for download backup action"),
...
extension JetpackBackupOptionsViewController: JetpackBackupOptionsView {
    ...
    func showBackupAlreadyRunning() {
        let title = AppLocalizedString("There's a backup currently being prepared, please wait before starting the next one", comment: "Text displayed when user tries to create a downloadable backup when there is already one being prepared")
    ...
    func showBackupRequestFailed() {
        let errorTitle = AppLocalizedString("Backup failed", comment: "Title for error displayed when preparing a backup fails.")
        let errorMessage = AppLocalizedString("We couldn't create your backup. Please try again later.", comment: "Message for error displayed when preparing a backup fails.")
