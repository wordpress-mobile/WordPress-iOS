...
class JetpackBackupStatusViewController: BaseRestoreStatusViewController {
    ...
    init(site: JetpackSiteRef, activity: Activity, downloadID: Int) {
        ...
        let restoreStatusConfiguration = JetpackRestoreStatusConfiguration(
            title: AppLocalizedString("Backup", comment: "Title for Jetpack Backup Status screen"),
            iconImage: .gridicon(.history),
            messageTitle: AppLocalizedString("Currently creating a downloadable backup of your site", comment: "Title for the Jetpack Backup Status message."),
            messageDescription: AppLocalizedString("We're creating a downloadable backup of your site from %1$@.", comment: "Description for the Jetpack Backup Status message. %1$@ is a placeholder for the selected date."),
            hint: AppLocalizedString("No need to wait around. We'll notify you when your backup is ready.", comment: "A hint to users about creating a downloadable backup of their site."),
            primaryButtonTitle: AppLocalizedString("Let me know when finished!", comment: "Title for the button that will dismiss this view."),
