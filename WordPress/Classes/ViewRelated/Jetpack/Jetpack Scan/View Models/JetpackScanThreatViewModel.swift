...
struct JetpackScanThreatViewModel {
    ...
    private struct Strings {
        ...
        struct details {
            ...
            struct titles {
                static let problem = AppLocalizedString("What was the problem?", comment: "Title for the problem section in the Threat Details")
                static let technicalDetails = AppLocalizedString("The technical details", comment: "Title for the technical details section in Threat Details")

                struct fix {
                    static let `default` = AppLocalizedString("How will we fix it?", comment: "Title for the fix section in Threat Details")
                    static let fixed = AppLocalizedString("How did Jetpack fix it?", comment: "Title for the fix section in Threat Details: Threat is fixed")
                    static let notFixable = AppLocalizedString("Resolving the threat", comment: "Title for the fix section in Threat Details: Threat is not fixable")
                }
            }

            struct descriptions {
                static let technicalDetails = AppLocalizedString("Threat found in file:", comment: "Description for threat file")

                struct fix {
                    static let replace = AppLocalizedString("Jetpack Scan will replace the affected file or directory.", comment: "Description that explains how we will fix the threat")
                    static let delete = AppLocalizedString("Jetpack Scan will delete the affected file or directory.", comment: "Description that explains how we will fix the threat")
                    static let update = AppLocalizedString("Jetpack Scan will update to a newer version.", comment: "Description that explains how we will fix the threat")
                    static let edit = AppLocalizedString("Jetpack Scan will edit the affected file or directory.", comment: "Description that explains how we will fix the threat")
                    struct rollback {
                        static let withTarget = AppLocalizedString("Jetpack Scan will rollback the affected file to the version from %1$@.", comment: "Description that explains how we will fix the threat")
                        static let withoutTarget = AppLocalizedString("Jetpack Scan will rollback the affected file to an older (clean) version.", comment: "Description that explains how we will fix the threat")
                    }

                    static let unknown = AppLocalizedString("Jetpack Scan will resolve the threat.", comment: "Description that explains how we will fix the threat")

                    static let notFixable = AppLocalizedString("Jetpack Scan cannot automatically fix this threat. We suggest that you resolve the threat manually: ensure that WordPress, your theme, and all of your plugins are up to date, and remove the offending code, theme, or plugin from your site.", comment: "Description that explains that we are unable to auto fix the threat")
                }
            }
            ...
            struct actions {
                ...
                struct titles {
                    static let ignore = AppLocalizedString("Ignore threat", comment: "Title for button that will ignore the threat")
                    static let fixable = AppLocalizedString("Fix threat", comment: "Title for button that will fix the threat")
                    ...
                    static let enterServerCredentialsFormat = AppLocalizedString("%1$@ to fix this threat.", comment: "Title for button when a site is missing server credentials. %1$@ is a placeholder for the string 'Enter your server credentials'.")
                }

                struct messages {
                    static let ignore = AppLocalizedString("You shouldn’t ignore a security issue unless you are absolutely sure it’s harmless. If you choose to ignore this threat, it will remain on your site \"%1$@\".", comment: "Message displayed in ignore threat alert. %1$@ is a placeholder for the blog name.")
                }
            }

            struct success {
                static let fix = AppLocalizedString("The threat was successfully fixed.", comment: "Message displayed when a threat is fixed successfully.")
                static let ignore = AppLocalizedString("Threat ignored.", comment: "Message displayed when a threat is ignored successfully.")
            }

            struct error {
                static let fix = AppLocalizedString("Error fixing threat. Please contact our support.", comment: "Error displayed when fixing a threat fails.")
                static let ignore = AppLocalizedString("Error ignoring threat. Please contact our support.", comment: "Error displayed when ignoring a threat fails.")
            }
        }
        ...
        struct titles {
            struct core {
                static let singular = AppLocalizedString("Infected core file", comment: "Title for a threat")
                static let multiple = AppLocalizedString("Infected core file: %1$@", comment: "Title for a threat that includes the file name of the file")
            }

            struct file {
                static let singular = AppLocalizedString("A file contains a malicious code pattern", comment: "Title for a threat")
                static let multiple = AppLocalizedString("The file %1$@ contains a malicious code pattern", comment: "Title for a threat that includes the file name of the file")
            }

            struct plugin {
                static let singular = AppLocalizedString("Vulnerable Plugin", comment: "Title for a threat")
                static let multiple = AppLocalizedString("Vulnerable Plugin: %1$@ (version %2$@)", comment: "Title for a threat that includes the file name of the plugin and the affected version")
            }

            struct theme {
                static let singular = AppLocalizedString("Vulnerable Theme", comment: "Title for a threat")
                static let multiple = AppLocalizedString("Vulnerable Theme %1$@ (version %2$@)", comment: "Title for a threat that includes the file name of the theme and the affected version")
            }

            struct database {
                static let singular = AppLocalizedString("Database threat", comment: "Title for a threat")
                static let multiple = AppLocalizedString("Database %1$d threats", comment: "Title for a threat that includes the number of database rows affected")
            }

            static let unknown = AppLocalizedString("Threat Found", comment: "Title for a threat")
        }

        struct description {
            static let core = AppLocalizedString("Vulnerability found in WordPress", comment: "Summary description for a threat")
            static let file = AppLocalizedString("Threat found %1$@", comment: "Summary description for a threat that includes the threat signature")
            static let plugin = AppLocalizedString("Vulnerability found in plugin", comment: "Summary description for a threat")
            static let theme = AppLocalizedString("Vulnerability found in theme", comment: "Summary description for a threat")
            static let database: String? = nil
            static let unknown = AppLocalizedString("Miscellaneous vulnerability", comment: "Summary description for a threat")
        }
    }
