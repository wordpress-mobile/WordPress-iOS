...
open class AboutViewController: UITableViewController {
    ...
    private func displayWebView(_ url: URL?, title: String? = nil) {
        ...
        if let title = title {
            present(webViewController: WebViewControllerFactory.controller(url: url, title: title, source: "about_view"))
        }
        else {
            present(webViewController: WebViewControllerFactory.controller(url: url, source: "about_view"))
        }
    }
