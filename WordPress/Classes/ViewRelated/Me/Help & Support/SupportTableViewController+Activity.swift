...
extension SupportTableViewController: SearchableActivityConvertable {
    ...
    var activityTitle: String {
        return AppLocalizedString("Help & Support", comment: "Title of the 'Help & Support' screen within the 'Me' tab - used for spotlight indexing on iOS.")
    }

    var activityKeywords: Set<String>? {
        let keyWordString = AppLocalizedString("wordpress, help, support, faq, questions, debug, logs, help center, contact",
