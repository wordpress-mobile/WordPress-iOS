...
final class AztecMediaPickingCoordinator {
    ...
    func present(
        in origin: UIViewController & UIDocumentPickerDelegate,
        blog: Blog
    ) {
    ...
    private func cancelAction() -> UIAlertAction {
        UIAlertAction(title: .cancelMoreOptions, style: .cancel, handler: nil)
    }
    ...
    private func showDocumentPicker(origin: UIViewController & UIDocumentPickerDelegate, blog: Blog) {
        ...
        let docPicker = UIDocumentPickerViewController(
            forOpeningContentTypes: docTypes.compactMap(UTType.init),
            asCopy: true
        )
