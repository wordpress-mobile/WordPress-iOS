...
private extension UnifiedPrologueEditorContentView {
    ...
    enum Appearance {
        static let topElementTitle = AppLocalizedString("Getting Inspired", comment: "Example post title used in the login prologue screens.")
        static let middleElementTitle = AppLocalizedString("I am so inspired by photographer Cameron Karsten's work. I will be trying these techniques on my next", comment: "Example post content used in the login prologue screens.")
