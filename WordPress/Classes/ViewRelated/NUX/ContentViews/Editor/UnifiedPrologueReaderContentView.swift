                ...
                RoundRectangleView {
                    ...
                    HStack {
                        ...
                        CircledIcon(
                            ...
                            backgroundColor: Color(AppStyleGuide.red(.shade40))
                        )
                    }
                }
                ...
                RoundRectangleView {
                    ...
                    HStack {
                        CircledIcon(
                            ...
                            iconType: .star,
                            backgroundColor: Color(AppStyleGuide.yellow(.shade20))
                        )
                ...
                RoundRectangleView {
                    ...
                    HStack {
                        ...
                        CircledIcon(
                            ...
                            backgroundColor: Color(AppStyleGuide.purple(.shade50))
                        )
                    }
                }
                .fixedSize(horizontal: false, vertical: true)
...
private struct TagItem: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .background(Color(UIColor(light: AppStyleGuide.gray(.shade0),
                                      dark: AppStyleGuide.gray(.shade70)))
            )
            .clipShape(Capsule())
    }
}
