...
class LoginEmailViewController: LoginViewController, SigninKeyboardResponder {
    ...
    @objc func localizeControls() {
        if loginFields.meta.jetpackLogin {
            instructionLabel?.text = NSLocalizedString("To view your stats, log in to the WordPress.com account you used to connect Jetpack.", comment: "Instruction text on the login's email addresss screen.")
        } else {
