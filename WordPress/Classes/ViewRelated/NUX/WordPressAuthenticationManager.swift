...
extension WordPressAuthenticationManager {
    ...
    private func authenticatorStyle() -> WordPressAuthenticatorStyle {
        ...
        return WordPressAuthenticatorStyle(
            primaryNormalBackgroundColor: AppStyleGuide.primary,
            primaryNormalBorderColor: nil,
            primaryHighlightBackgroundColor: AppStyleGuide.primary(.shade80),
            ...
            disabledBackgroundColor: AppStyleGuide.gray,
            disabledBorderColor: AppStyleGuide.neutral(.shade10),
            primaryTitleColor: .white,
            secondaryTitleColor: .label,
            disabledTitleColor: AppStyleGuide.neutral(.shade20),
            disabledButtonActivityIndicatorColor: .label,
            textButtonColor: AppStyleGuide.primary,
            textButtonHighlightColor: AppStyleGuide.primaryDark,
            ...
            navBarBadgeColor: AppStyleGuide.accent(.shade20),
            navBarBackgroundColor: .secondarySystemGroupedBackground,
            prologueBackgroundColor: AppStyleGuide.primary,
    ...
    private func unifiedStyle() -> WordPressAuthenticatorUnifiedStyle {
        ...
        return WordPressAuthenticatorUnifiedStyle(
            ...
            errorColor: AppStyleGuide.error,
            textColor: .label,
