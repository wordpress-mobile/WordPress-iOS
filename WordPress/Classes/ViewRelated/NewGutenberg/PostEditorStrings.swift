...
enum PostEditorStrings {
    ...
    // Close confirmation
    static let keepEditing = NSLocalizedString("postEditor.closeConfirmationAlert.keepEditing", value: "Keep Editing", comment: "Button to keep the changes in an alert confirming discarding changes")
    static let discardChanges = NSLocalizedString("postEditor.closeConfirmationAlert.discardChanges", value: "Discard Changes", comment: "Button in an alert confirming discarding changes")

    // Primary actions
    static let publish = NSLocalizedString("postEditor.publishButton.title", value: "Publish", comment: "Title for the publish button in the post editor navigation bar")
    static let update = NSLocalizedString("postEditor.updateButton.title", value: "Update", comment: "Title for the update button in the post editor navigation bar")
}
