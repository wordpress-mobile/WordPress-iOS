...
//        }
        ...
        guard let approveEnabled = block.command(id: ApproveComment.actionIdentifier())?.enabled, approveEnabled == true else {
            return rightButtons
        }
...
//        }
        ...
        if approveCommand?.enabled == true {
            ...
            title = NSLocalizedString("Approve", comment: "Approves a Comment")
        }
