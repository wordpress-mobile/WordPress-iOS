...
class PlanDetailViewController: UIViewController {
    ...
    fileprivate func configureAppearance() {
        planTitleLabel.textColor = .neutral(shade: .shade700)
        planDescriptionLabel.textColor = .neutral(shade: .shade300)
    ...
    fileprivate func configurePlanImageDropshadow() {
        ...
        dropshadowImageView.layer.shadowColor = UIColor.neutral(shade: .shade50).cgColor
