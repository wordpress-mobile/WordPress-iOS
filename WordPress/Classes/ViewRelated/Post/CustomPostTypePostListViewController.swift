...
final class CustomPostTypePostListViewController: AbstractPostListViewController, InteractivePostViewDelegate {
    ...
    @objc class func controllerWithBlog(_ blog: Blog, postType: PostType) -> CustomPostTypePostListViewController {
        let vc = CustomPostTypePostListViewController()
        vc.blog = blog
