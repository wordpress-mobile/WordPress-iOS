...
- (void)refreshButtons
{
    ...
    [self.navigationItem.rightBarButtonItem setTitleTextAttributes:titleTextAttributes forState:updateEnabled ? UIControlStateNormal : UIControlStateDisabled];
}
...
{
    if (self.activityDelegate) {
		[self.activityDelegate editPostViewDismissed];
	} else{
