...
class EditPostViewController: UIViewController {
    ...
    @objc convenience init(post: Post, shouldLoadAutosave: Bool = false) {
        self.init(post: post, blog: post.blog, shouldLoadAutosave: shouldLoadAutosave)
    }
    ...
    fileprivate init(post: Post?, blog: Blog, shouldLoadAutosave: Bool = false) {
        self.post = post
    ...
    fileprivate func showEditor() {
        let editor = editorFactory.instantiateEditor(
            for: postToEdit(),
            shouldLoadAutosave: shouldLoadAutosave,
