...
enum PostSearchHeader {
    static let published = AppLocalizedString("Published", comment: "Title of the published header in search list.")
    static let drafts = AppLocalizedString("Drafts", comment: "Title of the drafts header in search list.")
