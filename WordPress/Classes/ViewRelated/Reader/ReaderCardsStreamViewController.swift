...
class ReaderCardsStreamViewController: ReaderStreamViewController {
    ...
    private lazy var selectInterestsViewController: ReaderSelectInterestsViewController = {
        let title = AppLocalizedString("Discover and follow blogs you love", comment: "Reader select interests title label text")
        let subtitle = AppLocalizedString("Choose your topics", comment: "Reader select interests subtitle label text")
        let buttonTitleEnabled = AppLocalizedString("Done", comment: "Reader select interests next button enabled title text")
        let buttonTitleDisabled = AppLocalizedString("Select a few to continue", comment: "Reader select interests next button disabled title text")
        let loading = AppLocalizedString("Finding blogs and stories you’ll love...", comment: "Label displayed to the user while loading their selected interests")
