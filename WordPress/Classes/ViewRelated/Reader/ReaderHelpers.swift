...
struct ReaderPostMenuButtonTitles {
    static let cancel = AppLocalizedString("Cancel", comment: "The title of a cancel button.")
    static let blockSite = AppLocalizedString("Block this site", comment: "The title of a button that triggers blocking a site from the user's reader.")
    static let reportPost = AppLocalizedString("Report this post", comment: "The title of a button that triggers reporting of a post from the user's reader.")
    static let share = AppLocalizedString("Share", comment: "Verb. Title of a button. Pressing lets the user share a post to others.")
    static let visit = AppLocalizedString("Visit", comment: "An option to visit the site to which a specific post belongs")
    static let unfollow = AppLocalizedString("Unfollow site", comment: "Verb. An option to unfollow a site.")
    static let follow = AppLocalizedString("Follow site", comment: "Verb. An option to follow a site.")
    static let subscribe = AppLocalizedString("Turn on site notifications", comment: "Verb. An option to switch on site notifications.")
    static let unsubscribe = AppLocalizedString("Turn off site notifications", comment: "Verb. An option to switch off site notifications.")
    static let markSeen = AppLocalizedString("Mark as seen", comment: "An option to mark a post as seen.")
    static let markUnseen = AppLocalizedString("Mark as unseen", comment: "An option to mark a post as unseen.")
    static let followConversation = AppLocalizedString("Follow conversation by email", comment: "Verb. Button title. Follow the comments on a post.")
    static let unFollowConversation = AppLocalizedString("Unfollow conversation by email", comment: "Verb. Button title. The user is following the comments on a post.")
}
...
@objc open class ReaderHelpers: NSObject {
    ...
    private struct NoticeMessages {
        static let seenFail = AppLocalizedString("Unable to mark post seen", comment: "Notice title when updating a post's seen status failed.")
        static let unseenFail = AppLocalizedString("Unable to mark post unseen", comment: "Notice title when updating a post's unseen status failed.")
        static let seenSuccess = AppLocalizedString("Marked post as seen", comment: "Notice title when updating a post's seen status succeeds.")
        static let unseenSuccess = AppLocalizedString("Marked post as unseen", comment: "Notice title when updating a post's unseen status succeeds.")
        static let followSuccess = AppLocalizedString("Following %1$@", comment: "Notice title when following a site succeeds. %1$@ is a placeholder for the site name.")
        static let unfollowSuccess = AppLocalizedString("Unfollowed site", comment: "Notice title when unfollowing a site succeeds.")
        static let followFail = AppLocalizedString("Unable to follow site", comment: "Notice title when following a site fails.")
        static let unfollowFail = AppLocalizedString("Unable to unfollow site", comment: "Notice title when unfollowing a site fails.")
        static let notificationOnFail = AppLocalizedString("Unable to turn on site notifications", comment: "Notice title when turning site notifications on fails.")
        static let notificationOffFail = AppLocalizedString("Unable to turn off site notifications", comment: "Notice title when turning site notifications off fails.")
        static let notificationOnSuccess = AppLocalizedString("Turned on site notifications", comment: "Notice title when turning site notifications on succeeds.")
        static let notificationOffSuccess = AppLocalizedString("Turned off site notifications", comment: "Notice title when turning site notifications off succeeds.")
        static let enableNotifications = AppLocalizedString("Enable site notifications?", comment: "Message prompting user to enable site notifications.")
        static let enableButtonLabel = AppLocalizedString("Enable", comment: "Button title for the enable site notifications action.")
        static let blockSiteSuccess = AppLocalizedString("Blocked site", comment: "Notice title when blocking a site succeeds.")
        static let blockSiteFail = AppLocalizedString("Unable to block site", comment: "Notice title when blocking a site fails.")
        static let commentFollowSuccess = AppLocalizedString("Successfully followed conversation", comment: "The app successfully subscribed to the comments for the post")
        static let commentUnfollowSuccess = AppLocalizedString("Successfully unfollowed conversation", comment: "The app successfully unsubscribed from the comments for the post")
        static let commentFollowFail = AppLocalizedString("Unable to follow conversation", comment: "The app failed to subscribe to the comments for the post")
        static let commentUnfollowFail = AppLocalizedString("Failed to unfollow conversation", comment: "The app failed to unsubscribe from the comments for the post")
        static let commentFollowError = AppLocalizedString("Could not subscribe to comments", comment: "The app failed to subscribe to the comments for the post")
        static let commentUnfollowError = AppLocalizedString("Could not unsubscribe from comments", comment: "The app failed to unsubscribe from the comments for the post")
    }
}
