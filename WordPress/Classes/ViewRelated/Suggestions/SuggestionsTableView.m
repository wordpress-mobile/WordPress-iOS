                      ...
                      delegate:(id <SuggestionsTableViewDelegate>)suggestionsDelegate
{
    ...
    if (self) {
        ...
        _showLoading = NO;
        NSString *bundleIdentifier = [NSBundle mainBundle].bundleIdentifier ? :  @"org.wordpress";
        _searchOperationQueue = [NSOperationQueue new];
        _searchOperationQueue.maxConcurrentOperationCount = 1;
        _searchOperationQueue.name = [NSString stringWithFormat:@"%@.SearchDispatchQueue", bundleIdentifier];
