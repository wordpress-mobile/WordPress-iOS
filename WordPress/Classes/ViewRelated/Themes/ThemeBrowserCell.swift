    ...
    fileprivate func refreshGUI() {
        if let theme = theme {
            ...
            if theme.isCurrentTheme() {
                ...
                actionButton.setImage(activeEllipsisImage, for: UIControl.State())
                ...
                actionButton.setImage(inactiveEllipsisImage, for: UIControl.State())
...
extension ThemeBrowserCell: Accessible {
    ...
    private func prepareCellForVoiceOver() {
        ...
        if let name = theme?.name {
            ...
            imageView.accessibilityTraits = UIAccessibilityTraits(rawValue: UIAccessibilityTraits.button.rawValue | UIAccessibilityTraits.summaryElement.rawValue)
        }
    ...
    private func prepareActionButtonForVoiceOver() {
        ...
        actionButton.accessibilityTraits = UIAccessibilityTraits.button
    }
