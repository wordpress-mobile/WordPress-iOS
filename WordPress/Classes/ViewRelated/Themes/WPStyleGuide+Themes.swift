...
extension WPStyleGuide {
    public struct Themes {
        ...
        public static let currentThemeDividerColor: UIColor = .neutral(shade: .shade50)
        ...
        public static let searchBarBorderColor: UIColor = .neutral(shade: .shade100)

        public static let searchTypeTitleFont = WPFontManager.systemSemiBoldFont(ofSize: 14)
        public static let searchTypeTitleColor: UIColor = .neutral(shade: .shade700)
        ...
        public static let placeholderColor: UIColor = .neutral(shade: .shade100)

        public static let activeCellBackgroundColor: UIColor = .neutral(shade: .shade400)
        ...
        public static let inactiveCellDividerColor: UIColor = .neutral(shade: .shade50)
        public static let inactiveCellNameColor: UIColor = .neutral(shade: .shade700)
