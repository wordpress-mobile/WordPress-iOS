...
{
    return [title sizeWithFont:[WPStyleGuide subtitleFont] constrainedToSize:CGSizeMake(width - 2 * WPTableViewSectionFooterViewStandardOffset, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
}
