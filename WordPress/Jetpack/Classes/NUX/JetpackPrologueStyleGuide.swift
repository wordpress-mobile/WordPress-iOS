...
struct JetpackPrologueStyleGuide {
    ...
    static let siteTextColor = UIColor(light: AppStyleGuide.jetpackGreen(.shade90), dark: .white)
    static let siteHighlightedFillColor = UIColor.clear
    static let siteHighlightedBorderColor = UIColor.clear
    static let siteHighlightedTextColor = UIColor(light: AppStyleGuide.jetpackGreen(.shade50), dark: whiteWithAlpha07)
