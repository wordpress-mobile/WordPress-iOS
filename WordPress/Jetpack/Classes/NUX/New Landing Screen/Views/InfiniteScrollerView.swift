...
class InfiniteScrollerView: UIScrollView {
    ...
    private var singleViewHeight: CGFloat? {
        guard let stackView = stackView, !stackView.arrangedSubviews.isEmpty else {
            return nil
        }
    ...
    private func addViewsToStackView() {
        guard let viewBuilder = viewBuilder else { return }
    ...
    @objc private func step() {
        guard let scrollerDelegate = self.scrollerDelegate else { return }
        guard let singleViewHeight = self.singleViewHeight else { return }
        // the rate shouldn't be higher than the size of the view
        guard scrollerDelegate.rate < singleViewHeight else { return }
