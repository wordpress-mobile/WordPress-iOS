...
struct JetpackNotFoundErrorViewModel: JetpackErrorViewModel {
    ...
    private struct Constants {
        static let yourSite = AppLocalizedString("your site",
        ...
        static let description = AppLocalizedString("To use this app for %@ you'll need to have the Jetpack plugin installed and activated.",
