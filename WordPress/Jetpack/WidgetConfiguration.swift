...
@objc extension AppConfiguration {
    ...
    class Widget: NSObject {
        ...
        class Stats: NSObject {
            ...
            @objc static let lockScreenTodayViewsCommentsKind = "JetpackLockScreenWidgetTodayViewsComments"
            ...
            @objc static let lockScreenTodayViewsCommentsProperties = "JetpackLockScreenWidgetTodayViewsCommentsProperties"
