...
public class MediaEditorCrop: UIViewController {
    ...
    public func edit(from navigationController: UINavigationController? = nil, onFinishEditing: @escaping (UIImage, [MediaEditorOperation]) -> (), onCancel: (() -> ())? = nil) {
...
extension MediaEditorCrop: TOCropViewControllerDelegate {
