...
public class ForcePopoverPresenter: NSObject, UIPopoverPresentationControllerDelegate {
    ...
    public static func configurePresentationControllerForViewController(_ controller: UIViewController, presentingFromView sourceView: UIView) {
