...
extension XCTestCase {
    ...
    public func setUpTestSuite(
        ...
        app.launchArguments = ["-wpcom-api-base-url", WireMock.URL().absoluteString, "-no-animations", "-ui-testing", "-logout-at-launch", "-wpcom-base-url", WireMock.URL().absoluteString]
