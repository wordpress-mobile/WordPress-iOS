...
struct WPUITestCredentials {
    ...
    static let testWPcomPrimaryPaidSite: String = "tricountyrealestate.wordpress.com"
    static let testWPcomSecondaryFreeSite: String = "fourpawsdoggrooming.wordpress.com"
