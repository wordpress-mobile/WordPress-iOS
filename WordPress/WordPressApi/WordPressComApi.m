...
- (NSString *)errorMessageForError:(NSError *)error
{
    ...
    if ([errorCode isEqualToString:@"username_only_lowercase_letters_and_numbers"]) {
        ...
        return NSLocalizedString(@"Sorry, that password does not meet our security guidelines. Please choose a password with a mix of uppercase letters, lowercase letters, numbers and symbols.", @"");
