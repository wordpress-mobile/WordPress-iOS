...
fileprivate extension ShareExtensionEditorViewController {
    ...
    struct ShareColors {
        ...
        static let aztecCursorColor               = AppStyleGuide.primary
        static let aztecFormatBarInactiveColor    = UIColor.secondaryLabel
        static let aztecFormatBarActiveColor      = AppStyleGuide.primary

        static var aztecFormatPickerSelectedCellBackgroundColor: UIColor {
            get {
                return (UIDevice.current.userInterfaceIdiom == .pad) ? .systemGroupedBackground : AppStyleGuide.neutral(.shade5)
            }
        }
