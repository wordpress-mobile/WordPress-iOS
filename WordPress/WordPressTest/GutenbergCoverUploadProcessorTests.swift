...
class GutenbergCoverUploadProcessorTests: XCTestCase {
    ...
    func testCoverBlockProcessorWithOtherAttributes() {
        ...
        XCTAssertEqual(parser.toString(), postResultContentWithOtherAttributes, "Post content should be updated correctly")
    }
    ...
    func testVideoCoverBlockProcessor() {
        ...
        XCTAssertEqual(parser.toString(), postResult, "Post content should be updated correctly")
    }
