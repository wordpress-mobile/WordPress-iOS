...
"""
    ...
    func testRefactoredGalleryImageBlockProcessor() {
        ...
        XCTAssertEqual(parser.toString(), refactoredGalleryResultContent, "Post content should be updated correctly")
    }
    ...
    func testRefactoredGalleryBlockProcessor() {
        ...
        XCTAssertEqual(parser.toString(), galleryResultBlockContent, "Post content should be updated correctly")
    }
    ...
    func testMixedOldRefactoredGalleryBlockProcessor() {
        ...
        XCTAssertEqual(parser.toString(), postResultContent, "Post content should be updated correctly")
    }
}
