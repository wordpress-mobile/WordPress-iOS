...
//        let asset = assetForFile(named: testDeviceImageNameWithGPS)
...
//            return
//        }
//        let asset = assetForFile(named: testImageNameInPortrait)
//        let exporter = MediaAssetExporter(asset: asset)
...
//        let asset = assetForFile(named: testDeviceImageNameWithGPSInPortrait)
//        let exporter = MediaAssetExporter(asset: asset)
//        let maximumImageSize = CGFloat(200)
//        exporter.mediaDirectoryType = .temporary
//        var options = MediaImageExporter.Options()
