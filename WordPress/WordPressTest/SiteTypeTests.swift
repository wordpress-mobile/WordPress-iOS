...
final class SiteTypeTests: XCTestCase {
    ...
    override func setUp() {
        ...
        subject = try! jsonDecoder.decode(Segment.self, from: data)
    }
    ...
    func testSiteTypesWithSameIdAreEqual() {
        let secondSiteType = Segment(identifier: MockValues.identifier, title: "Another title", subtitle: "It does not matter", icon: MockValues.icon)
