...
class ActivityServiceRemoteTests: RemoteTestCase, RESTTestable {
    ...
    let getActivitySuccessOneMockFilename = "activity-log-success-one.json"
    let getActivitySuccessTwoMockFilename = "activity-log-success-two.json"
    let getActivitySuccessThreeMockFilename = "activity-log-success-three.json"
