...
# download_jetpack_localized_app_store_metadata
# -----------------------------------------------------------------------------------
# Downloads localized metadata (intended for App Store Connect) from GlotPress for Jetpack.
# -----------------------------------------------------------------------------------
# Usage:
# bundle exec fastlane download_jetpack_localized_app_store_metadata
#####################################################################################
desc 'Downloads localized Jetpack metadata (for App Store Connect) from GlotPress'
